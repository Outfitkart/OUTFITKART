...
const CATEGORIES=[
    ...
    {id:'women',name:'Women',
     ...
     subs:['Sarees','Kurtis','Lehengas','Tops','Shirts','Straight Fit Jeans','Trousers','Baggy Jeans','Cargo Jeans','Skinny Fit Jeans','Slim Fit Jeans','Palazzo','Tops & Tunics','Dresses','Skirts','Heels','Flats','Sandals','Sneakers','Wedges'],
     groups:[
         ...
         {label:'👗 Western',items:['Tops','Shirts','Palazzo','Tops & Tunics','Dresses','Skirts']},
    ...
    {id:'accessories',name:'Accessories',
     ...
     subs:['Sunglasses','Watches','Wallets','Belts','Caps','Chains','Bracelets','Socks','Handbags','Clutches','Hair Accessories','Scrunchies','Unisex Sunglasses','Phone Cases','Backpacks'],
     groups:[
         {label:"👨 Men's Accessories",items:['Sunglasses','Watches','Wallets','Belts','Caps','Chains','Bracelets','Socks']},
         {label:"👩 Women's Accessories",items:['Handbags','Clutches','Hair Accessories','Scrunchies','Belts']},
         {label:'✨ Unisex',items:['Unisex Sunglasses','Phone Cases','Backpacks']},
     ]},
    {id:'bags',name:'Bags',
     photo:'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=120&h=120&fit=crop&q=80',
     subs:["Men's Bags","Women's Bags","Backpacks","Tote Bags","Clutch Bags","Laptop Bags","Travel Bags","Sling Bags","College Bags","Gym Bags"],
     groups:[
         {label:"👜 Women's Bags",items:["Women's Bags","Tote Bags","Clutch Bags","Sling Bags"]},
         {label:"💼 Men's Bags",items:["Men's Bags","Laptop Bags","Gym Bags"]},
         {label:'🎒 Unisex',items:['Backpacks','Travel Bags','College Bags']},
     ]},
    {id:'jewellery',name:'Jewellery',
     photo:'https://images.unsplash.com/photo-1599643477877-530eb83abc8e?w=120&h=120&fit=crop&q=80',
     subs:['Earrings','Necklace Sets','Bangles','Rings','Anklets','Bracelets','Chains','Maang Tikka','Nose Rings','Men Chains','Men Bracelets','Couple Rings'],
     groups:[
         {label:'💍 Women Jewellery',items:['Earrings','Necklace Sets','Bangles','Rings','Anklets','Maang Tikka','Nose Rings']},
         {label:'🔗 Men Jewellery',items:['Men Chains','Men Bracelets','Couple Rings']},
         {label:'✨ Unisex',items:['Bracelets','Chains']},
     ]},
    {id:'electronics',name:'Electronics',
     photo:'https://images.unsplash.com/photo-1550009158-9ebf69173e03?w=120&h=120&fit=crop&q=80',
     subs:['Earbuds','TWS Earphones','Wired Earphones','Bluetooth Speakers','Smartwatches','Power Banks','Phone Cases','Cables & Chargers','LED Lights','Selfie Sticks','Screen Guards','PopSockets'],
     groups:[
         {label:'🎧 Audio',items:['Earbuds','TWS Earphones','Wired Earphones','Bluetooth Speakers']},
         {label:'⌚ Wearables',items:['Smartwatches']},
         {label:'🔋 Power & Accessories',items:['Power Banks','Cables & Chargers','LED Lights']},
         {label:'📱 Phone Accessories',items:['Phone Cases','Screen Guards','PopSockets','Selfie Sticks']},
     ]},
];
...
function navigate(view,cat=null){
    ...
    if(view==='product'){window._prevView=currentView;window._prevCat=cat||null;}
